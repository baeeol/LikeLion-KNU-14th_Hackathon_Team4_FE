...
function BottomNavigation({navigate}: {navigate: Navigate}) { return <View style={styles.bottomNav}><NavItem icon="⌂" label="홈" active /><NavItem icon="ai" label="AI 상담" onPress={() => navigate('routineConsult')} /><NavItem icon="⌕" label="제품 찾기" onPress={() => navigate('productExplore')} /><NavItem icon="♙" label="마이" /></View>; }
