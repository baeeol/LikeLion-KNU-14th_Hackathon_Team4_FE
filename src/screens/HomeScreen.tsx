...
const WEEKLY_ROUTINE = [
  {day: '월', routine: '레티놀', tone: 'green'}, {day: '화', routine: 'AHA', tone: 'orange'},
  {day: '수', routine: '진정', tone: 'mint'}, {day: '목', routine: '레티놀', tone: 'green'},
  {day: '금', routine: 'AHA', tone: 'orange'}, {day: '토', routine: '진정', tone: 'mint'},
